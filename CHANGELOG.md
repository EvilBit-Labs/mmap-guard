...
- **ci**: Add uv tool so pipx tools use the uvx backend ([#82](https://github.com/EvilBit-Labs/mmap-guard/pull/82))
...
- Repo-config cleanup (CodeRabbit filename + untrack .vscode/settings.json) ([#71](https://github.com/EvilBit-Labs/mmap-guard/pull/71))
...
- **deps**: Migrate to fs4 1.1 lock API + memmap2 0.9.11 (RUSTSEC-2026-0186) ([#61](https://github.com/EvilBit-Labs/mmap-guard/pull/61))

### Testing

- **fuzz**: Enhance fuzzing capabilities and CI workflows with documentation ([#10](https://github.com/EvilBit-Labs/mmap-guard/pull/10))

### Miscellaneous Tasks

- **mergify**: Upgrade configuration to current format ([#35](https://github.com/EvilBit-Labs/mmap-guard/pull/35))
- Fix garbled mise-action version pin comment (v4.0.1) ([#63](https://github.com/EvilBit-Labs/mmap-guard/pull/63))
<!-- generated by git-cliff -->
...
- Enhance mmap functionality and update related documentation ([#4](https://github.com/EvilBit-Labs/mmap-guard/pull/4))

### Bug Fixes

- Enhance documentation and optimize IO buffer allocation ([#8](https://github.com/EvilBit-Labs/mmap-guard/pull/8))
...
- Fix stale comments post advisory-locking ([#5](https://github.com/EvilBit-Labs/mmap-guard/pull/5))
